...
//$_POST["contactEmail"] = "not@email.com";
//$_POST["contactMessage"] = "testMessage2";

//$_POST["subscribeEmail"] = "not@email.com";
...
if ( isset($_POST["contactName"]) && isset($_POST["contactEmail"]) && isset($_POST["contactMessage"]) ) {
   //contact form submited, make sure its a valid email , get variables, prepared for DB
   ...
   echo json_encode(array(
   ...
   } else if ( isset($_POST["subscribeEmail"]) ) {
      //subscribe form submitted , get email prepared for db
      ...
      $result = $mysqli->query($query) or exitWithErrorJSON("Could not subscribe!");
