...
class User extends Savable {
   ...
   public function __construct( $email , $name = NULL) {
      ...
      try {
            ...
            if ( ($name != NULL) ){
               //a name was supplied in constructer, I do it like this so that the class is aware we have changes to what is in the DB
					//setName will take care of checking if its a new name and setting the $changed for save() function to be aware somehting is different
               $this->setName( $name );
            }
      } catch (Exception $e) {
